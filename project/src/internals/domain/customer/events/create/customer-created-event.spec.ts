...
import { SendLogHandler } from "./handlers/send-log-handler.ts";
import { customerDispatcher } from "../customer-dispatcher.ts";
import { SendLogHandler2 } from "./handlers/send-log2-handler.ts";
...
describe("Customer Created Event", () => {
  ...
  describe("notify", () => {
    it("should notify ", () => {
      ...
      const handlerSpy = spyOn(eventLogHandler, "handle");
