...
import { Address } from "../value-objects/address/address.ts";
import { CustomerConstructor, ICustomer } from "./customer-protocol.ts";
import { DomainException } from "@shared/errors/domain.error.ts";
import { NotFoundException } from "@shared/errors/not-found.error.ts";
