...
import { productDispatcher } from "../product-dispatcher.ts";
import { SendEmailWhenProductIsCreatedHandler } from "./handlers/send-mail-when-product-is-created-handler.ts";
import { SendNotifyWhenProductIsCreatedHandler } from "./handlers/send-notify-when-product-is-created-handler.ts";
...
describe("Product Created Event", () => {
  ...
  describe("notify", () => {
    it("should notify ", () => {
      ...
      const handlerSpy = spyOn(eventHandlerToNotify, "handle");
      const notifyHandler = new SendNotifyWhenProductIsCreatedHandler();
      const notifyHandlerSpy = spyOn(notifyHandler, "handle");
